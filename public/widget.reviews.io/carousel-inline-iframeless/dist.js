...
function reviewsio_renderReview(review, userVaribles ){
  ...
  if(userVaribles.THIRD_PARTY){
    ...
    if(reviewIndex == 0){
      var html=
      '<div tabindex="0" role="button" class=" R-ReviewsList__item u-textLeft--all  '+(userVaribles.options.popups.enable_review_popups? 'u-cursorPointer':'')+' js-open-widgetModal" r-popup="js-popup--'+review.store_review_id+'" id="ReviewsList__item--first'+userVaribles.element_id+'">';
    }
    else{
      var html= '<div tabindex="0" role="button" class="R-ReviewsList__item '+(userVaribles.options.popups.enable_review_popups? 'u-cursorPointer':'')+' u-textLeft--all js-open-widgetModal" r-popup="js-popup--'+review.store_review_id+'"id="ReviewList__item--' + review.store_review_id + '">';
    }
