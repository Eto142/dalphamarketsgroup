                            ...
                            <div class="row">
                                <div class="col-7">
                                    <div class="text-primary p-4">
                                        ...
                                        <p style="color: white">Sign in to continue to DALPHA MARKETS.</p>
                                    </div>
                                </div>
                                ...
                                <p class="response"></p>
                                   ...
                                   <form class="form-horizontal" action="{{ route('login') }}"  method="POST" >
                                    ...
                                    <div class="mt-3 d-grid">
                                        <button class="btn btn-success waves-effect waves-light" style="background-color: rgb(5, 5, 66)"  type="submit">  {{ __('Login') }}</button>
                                    </div>
