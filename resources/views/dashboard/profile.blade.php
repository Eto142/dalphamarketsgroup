...
<div class="mb-4">
    <h4 class="text-dark">Stay Connected With Us</h4>
    <p class="text-muted" style="max-width: 600px;">
        Help us keep in touch by updating your social media handles. 
        Adding your <strong>Facebook</strong> and <strong>Instagram</strong> links allows us to share important updates, promotions, and community news directly with you.
    </p>
</div>
...
<form action="{{ route('socialmedia.update') }}" method="POST">
    ...
    <div class="data-item">
        <div class="data-col">
            <label class="data-label">Facebook</label>
            <input 
                type="text" 
                name="facebook" 
                value="{{ Auth::user()->facebook }}" 
                class="form-control form-control-lg" 
                placeholder="Enter your Facebook username or link"
            >
        </div>
    </div>
    ...
    <div class="data-item mt-3">
        <div class="data-col">
            <label class="data-label">Instagram</label>
            <input 
                type="text" 
                name="instagram" 
    ...
    <div class="data-item mt-4">
        <div class="data-col">
            <button type="submit" name="upload" class="btn btn-lg btn-warning">
                Save Changes
            </button>
        </div>
    </div>
