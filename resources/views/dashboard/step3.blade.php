...
<head>
    <meta charset="utf-8" />
    <title>Dalphamarkets.com | Account</title>
...
<body style="background-color: rgb(5, 5, 66)">
    <div class="account-pages my-5 pt-sm-5"style="background-color: rgb(5, 5, 66)">
      ...
      <p>We’ve sent an email with your 4-digit PIN to  {{Auth::user()->email}}
If it doesn’t appear in your inbox within a few minutes, please check your SPAM or JUNK folder.</p>
     If you still can’t find it, click 'Resend PIN' to request a new one
...
<script>
    $(document).ready(function() {
        $('#login_form').on('submit', function(e) {
            ...
            $.ajax({
                type: "POST",
                url: 'https://dalphamarkets.com/custom-login',
                data: $(this).serialize(),
                dataType: "json",
