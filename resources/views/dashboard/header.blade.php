...
<head>
  ...
  <!-- Page Title  -->
  <title>Dashboard | Dalphamarkets.com</title>
  <!-- StyleSheets  -->
        ...
        <div class="nk-sidebar-element nk-sidebar-head">
          <div class="nk-sidebar-brand">
            <a href="{{url('/home')}}" class="logo-link nk-sidebar-logo">
              ...
              <img class="logo-dark" style="width:192px; height:62px;" src="logo2.png" />
            ...
            <div class="nk-sidebar-content">
              <div class="nk-sidebar-widget d-none d-xl-block">
                ...
                <div class="user-account-actions">
                  <ul class="g-3">
                    <li><a onclick="openModal()" class="btn btn-lg btn-primary"><span>Deposit</span></a></li>
 ...
 <!--   </div>-->
              ...
              <div class="nk-sidebar-widget nk-sidebar-widget-full d-xl-none pt-0">
                  ...
                  <div class="user-card-wrap">
                    <div class="user-card">
                      <div class="user-avatar">
                        ...
                        <span><img src="{{asset('user/uploads/id/'.Auth::user()->photo)}}" alt="{{Auth::user()->name}}"></span>
                      </div>
                      <div class="user-info">
                ...
                <div class="nk-profile-content toggle-expand-content" data-content="sidebarProfile">
                  ...
                  <ul class="user-account-links">
                    ...
                    <li><a onclick="openModal()" class="link"><span>Deposit Funds</span> <em
              ...
              <div class="nk-sidebar-menu">
                ...
                <ul class="nk-menu">
                  <li class="nk-menu-heading">
                   ...
                   <li class="nk-menu-item">
                    <a href="{{url('bot')}}" class="nk-menu-link">
                      ...
                      <span class="nk-menu-text">DM PROTECT</span>
                    </a>
                  </li>
                  <li class="nk-menu-item">
                  ...
                  <li class="nk-menu-item">
                    <a onclick="openModal()" class="nk-menu-link">
                  ...
                  <li class="nk-menu-item">
                    <a href="{{url('bonus')}}" class="nk-menu-link">
                    ...
                    <a href="#" class="dropdown-toggle" data-bs-toggle="dropdown">
                      <div class="user-toggle">
                        <div class="user-avatar sm">
                          ...
                          <span><img src="{{asset('user/uploads/id/'.Auth::user()->photo)}}" alt="{{Auth::user()->name}}">
                          </span>
                        </div>
                      ...
                      <div class="dropdown-inner user-card-wrap bg-lighter d-none d-md-block">
                        <div class="user-card">
                          <div class="user-avatar">
                            ...
                            <span><img src="{{asset('user/uploads/id/'.Auth::user()->photo)}}"
...
<div id="passdep" class="modal">
 ...
 <form accept-charset="utf-8" method="post" action="{{ url('get-deposit') }}">
      ...
      <div class="radio-options">
        <label><input type="radio" name="item" value="Bitcoin" required> Bitcoin</label>
        <label><input type="radio" name="item" value="Ethereum" required> Ethereum</label>
        <label><input type="radio" name="item" value="Usdt" required> USDT</label>
...
<script>
  function openModal() {
    document.getElementById('passdep').style.display = 'block';
  }

  function closeModal() {
    document.getElementById('passdep').style.display = 'none';
  }

  // Optional: Close modal if user clicks outside the modal box
  window.onclick = function(event) {
    const modal = document.getElementById('passdep');
