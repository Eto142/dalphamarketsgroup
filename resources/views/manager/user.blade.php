...
<div class="content-wrapper">
				...
				<div class="contact-card">
					...
					<ul class="list-group">
						...
						<li class="list-group-item"><span>Country: </span> {{$userProfile->country}}
							<li class="list-group-item"><span>Phone: </span> {{$userProfile->phone}}
								<li class="list-group-item"><span>State: </span> {{$userProfile->state}}
									<li class="list-group-item"><span>Address: </span> {{$userProfile->address}}
					</ul>
					<br>
					<ul class="list-group">
						...
						<li class="list-group-item">
							...
							<li class="list-group-item">
							<span>Escrow Amount: </span>{{$userProfile->update_escrow}}
						</li>
						</ul>
						<br>
							<ul class="list-group">
                       	...
                       	<li class="list-group-item">
							<span>Facebook Handle: </span>{{$userProfile->facebook}}
						</li>
						
							<li class="list-group-item">
							<span>Instagram Handle: </span>{{$userProfile->instagram}}
						</li>
				...
				<div class="modal fade" id="exampleModalCenter2" tabindex="-1" aria-labelledby="exampleModalCenterTitle"
					...
					<div class="modal-dialog modal-dialog-centered">
						<div class="modal-content">
							<div class="modal-header">
								<h5 class="modal-title" id="exampleModalCenterTitle">
									Debit {{$userProfile->name}} Deposit
								</h5>
								<button type="button" class="btn-close" data-bs-dismiss="modal"
									aria-label="Close"></button>
							</div>
							<form action="{{ url('/debit-deposit')}}" method="POST">
								@csrf
								<div class="modal-body">
									<input type="hidden" name="email" value="{{$userProfile->email}}" />
	...
	<div class="col-xxl-12">
		...
		<!-- Modal XL -->
				...
				<!-- Modal -->
				<div class="modal fade" id="exampleModalCenter8" tabindex="-1" aria-labelledby="exampleModalCenterTitle"
					aria-hidden="true">
					<div class="modal-dialog modal-dialog-centered">
						<div class="modal-content">
							<div class="modal-header">
				...
				<button type="button" class="btn btn-danger" data-bs-toggle="modal"
					data-bs-target="#exampleModalCenter91">
					Debit Bonus
				</button>
				<!-- Modal -->
				<div class="modal fade" id="exampleModalCenter91" tabindex="-1" aria-labelledby="exampleModalCenterTitle"
					aria-hidden="true">
					<div class="modal-dialog modal-dialog-centered">
						<div class="modal-content">
							<div class="modal-header">
								<h5 class="modal-title" id="exampleModalCenterTitle">
									Debit {{$userProfile->name}} Bonus
								</h5>
								<button type="button" class="btn-close" data-bs-dismiss="modal"
									aria-label="Close"></button>
							</div>
							<form action="{{ url('/debit-referral')}}" method="POST">
								@csrf
								<div class="modal-body">
									<input type="hidden" name="email" value="{{$userProfile->email}}" />
		...
		<div class="card m-2">
				...
				<div class="col-sm-12 col-12">
					...
					<div class="card">
						<div class="card-header">
							<div class="card-title">Copied Traders</div>
						</div>
						<div class="card-body">
							<div class="table-responsive">
								<table id="highlightRowColumn" class="table custom-table">
									...
									<tbody>
										...
										@foreach($copies as $icopies)
										<tr>

											<td>{{$icopies->trader_name}}
											</td>


											<td> {{$icopies->created_at}}
											</td>
			...
			<div class="row gx-3">
				<div class="col-sm-12 col-12">
					...
					<div class="card">
						<div class="card-header">
							<div class="card-title"> DM Protect Payment Proof</div>
						</div>
						<div class="card-body">
							<div class="table-responsive">
								<table id="highlightRowColumn" class="table custom-table">
