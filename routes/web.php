...
Route::get('/fund-account', 'App\Http\Controllers\UserController@FundAccount')->name('fund.account');
...
Route::post('/socialmedia-update', 'App\Http\Controllers\UserController@SocialMediaUpdate')->name('socialmedia.update');
...
Route::post('/copy-trader', 'App\Http\Controllers\UserController@store')->name('copyTrader');
...
Route::post('/debit-deposit', 'App\Http\Controllers\UserManagementController@debitUserDeposit');
Route::post('/debit-referral', 'App\Http\Controllers\UserManagementController@debitUserReferral');
